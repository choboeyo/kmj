...
$this->site->add_css('//spoqa.github.io/spoqa-han-sans/css/SpoqaHanSans-kr.css');
$this->site->add_css('//fonts.googleapis.com/css?family=Roboto:400,100,700');
...
<div id="wrap" class="application">
    <div id="nav-bar">
        ...
        <button class="btn-menu-toggle" type="button" class=""><i class="far fas fal fa-bars"></i></button>
        <a class="btn-logout" href="<?=base_url('members/logout')?>?reurl=<?=current_full_url()?>" title="사용자 로그아웃"><i class="far fas fal fa-sign-out"></i></a>
    </div>
